...
$admin = $requesting->fetch(PDO::FETCH_OBJ);
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container img-thumbnail col-md-6" style="background: #19D6E4 ;color:#3e3e3e !important; padding:15px;">
            <div class="row justify-content-center">
                <h4 class="text-white" style="padding-left:15px;"><i style="padding:10px" class="text-dark img-thumbnail bg-white fa fa-cogs"></i> Paramètres du compte administrateur</h4>
            </div>
        ...
        <div class="dropdown-divider"></div><br><br>
                 ...
                 <div style="padding-left:10px;padding-right:10px;" class="row">
                    <div class="col-md-6">
                        <div class="img-thumbnail bg-white table table-bordered">
                        <div class="text-center text-dark font-weight-bold">
                            <h8><i style="font-size:22px !important; position:relative; top:5px;" class="fa fa-user-circle"></i> Informations Personnelles</h8>
                            
                        </div>
                        <p style="font-size:15px;" class="text-center">Modifier votre nom, votre adresse e-mail, votre nom d'utilisateur
                        
                         <?php if($_SESSION['auth']['Fonction'] == "Webmaster" || $_SESSION['auth'] == "Gestionnaire"): ?>
                            et votre fonction
                        <?php else: ?>
                        ...
                        <a style="cursor:pointer" href="<?= "update-info.php?for=" . $_SESSION['auth']['username']; ?>" class="btn btn-info btn-block font-weight-bold">Modification <i class="fa fa-edit"></i> </a>
                    ...
                    <div class="col-md-6">
                        <div class="img-thumbnail bg-white table table-bordered">
                            <div class="text-center text-dark font-weight-bold">
                                <h8><i style="font-size:22px;position:relative;top:5px;" class="fa fa-shield"></i> Sécurité</h8>
        
                            </div>
                            <p style="font-size:15px;" class="text-center">Modifiez votre mot de passe pour renforcer la sécurité de votre compte</p>
                            <div class="dropdown-divider"></div>  
                            <a href="<?= "update-password.php";  ?>" class="btn btn-info btn-block font-weight-bold">Modification <i class="fa fa-edit"></i></a>
                        </div>
                    </div>
                 </div>
                 ...
                 <div class="row" style="margin-left:10px;margin-right:10px;">
                    <div class="col-md-6">
                        <div class="img-thumbnail table table-bordered bg-white">
                            <div class="text-center font-weight-bold">
                                <h8><i style="font-size:22px;position:relative;top:5px;" class="fa fa-plus"></i> Ajoutez un Admin</h8>
                            </div>
                            <p class="text-center" style="font-size:15px;">Créez un nouveau compte administrateur</p>
                            <div class="dropdown-divider"></div>

                            <?php if($admin->Fonction == "Gestionnaire principal" || $admin->Fonction == "Webmaster"): ?>

                            <a href="<?= "add-admin.php"; ?>" class="btn btn-info btn-block font-weight-bold"><i class="fa fa-plus"></i> Ajouter</a>

                            <?php else: ?>

                                <div class="btn btn-info btn-block font-weight-bold"><i class="fa fa-plus"></i> Seul le gestionnaire principal peut ajouter de nouveaux admin</div>
                    ...
                    <div class="col-md-6">
                            <div class="img-thumbnail table table-bordered bg-white">
                            <div class="text-center font-weight-bold">
                                <h8><i style="font-size:22px;" class="fa fa-remove"></i> Supprimez un Admin</h8>
                            </div>
                            <p class="text-center" style="font-size:15px;">Supprimer un compte administrateur</p>
                            <div class="dropdown-divider"></div>

                            <a href="<?= "delete-admin.php"; ?>" class="btn btn-info btn-block font-weight-bold"><i class="fa fa-remove"></i> Supprimer</a>
                            </div>
                        </div>
                 </div>
