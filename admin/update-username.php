...
if(isset($_POST['submit']))
{
    ...
    {
        $usernameError = "Le nom d'utilisateur ne peut pas commencer par un chiffre";
        $isSuccess = false;
    }
    ...
    if($isSuccess)
    {
        $req = $db->prepare("UPDATE admin SET username = ? WHERE id = ?");
        $req->execute([$username, $admin->id]);
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container img-thumbnail col-md-6" style="background: #19D6E4 ;color:#3e3e3e !important; padding:15px;">
            <div class="row justify-content-center">
                <h4 class="text-white" style="padding-left:15px;"><i style="padding:10px; color:#19d6e4 !important;" class="text-dark img-thumbnail bg-white fa fa-check"></i> Mise à jour du nom d'utilisateur</h4>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="username" value="<?= $admin->username; ?>" class="form-control text-center">
