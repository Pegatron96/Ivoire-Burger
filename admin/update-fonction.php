...
if(isset($_POST['submit']))
{
    ...
    if($isSuccess)
    {
        $req = $db->prepare("UPDATE admin SET Fonction = ? WHERE id = ?");
        $req->execute([$fonction, $admin->id]);
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container img-thumbnail col-md-6" style="background: #19D6E4 ;color:#3e3e3e !important; padding:15px;">
            <div class="row justify-content-center">
                <h4 class="text-white" style="padding-left:15px;"><i style="padding:10px; color:#19D6E4 !important;" class="text-dark img-thumbnail bg-white fa fa-check"></i> Mise à jour de la fonction</h4>
            </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="fonction" class="form-control">
                            <option selected value="<?= $admin->Fonction ?>" class="text-center"><?= $admin->Fonction; ?></option>
                            <option value="Gestionnaire principal">Gestionnaire principal</option>
                            <option value="Gestionnaire secondaire">Gestionnaire secondaire</option>
                            <option value="Gestionnaire des stocks">Gestionnaire des stocks</option>
