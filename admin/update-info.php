    ...
    <div id="page-content-wrapper">
        ...
        <div class="container img-thumbnail col-md-6" style="background: #19D6E4 ;color:#3e3e3e !important; padding:15px;">
            <div class="row justify-content-center">
                <h4 class="text-white" style="padding-left:15px;"><i style="padding:10px;color:#19D6E4 !important" class="text-dark img-thumbnail bg-white fa fa-user-circle"></i> Mise à jour des informations personnelles</h4>
            </div>
        ...
        <div class="dropdown-divider"></div><br><br>
            ...
            <div style="margin:auto !important;width:auto !important;padding:10px;word-wrap:break-word;overflow:auto;" class="col-md-6">
                <div class="form-group form-control" style="padding-left:20px;">
                    <label style="font-size:17px;" for="firstname" class="font-weight-bold">Nom et prénom(s) <a href="<?= "update-name.php" ?>"><i style="font-size:20px;position:relative;top:3px;" class="fa fa-edit text-dark"></i></a></label> <br>
                    <label><?= $admin->firstname . " " . $admin->lastname; ?></label>
                    <div class="dropdown-divider"></div>

                    <div class="form-group">
                        <label style="font-size:17px;" for="username" class="font-weight-bold">Nom d'utilisateur <a href="<?= "update-username.php" ?>"><i style="font-size:20px;position:relative;top:3px;" class="fa fa-edit text-dark"></i></a></label><br>
                        <label><?= $admin->username; ?></label>
                    <div class="dropdown-divider"></div>

                    <div class="form-group">
                        <label style="font-size:17px;" for="email" class="font-weight-bold">Adresse e-mail <a href="<?= "update-email.php" ?>"><i style="font-size:20px;position:relative;top:3px;" class="fa fa-edit text-dark"></i></a></label><br>
                        <label><?= $admin->email; ?></label>
                        <div class="dropdown-divider"></div>
                        <label style="font-size:17px;" for="fonction" class="font-weight-bold">Fonction 
                        
                        <?php if($admin->Fonction == "Webmaster" || $admin->Fonction == "Gestionnaire principal"): ?>

                        <a href="<?= "update-fonction.php"; ?>"><i style="font-size:20px;position:relative;top:3px;" class="fa fa-edit text-dark"></i></a></label><br>
                        
                        <?php else: ?>

                       <i data-toggle="tooltip" title="Vous devez être webmaster ou gestionnaire principal pour pouvoir modifier votre fonction" style="font-size:20px;position:relative;top:3px;cursor:pointer;" class="fa fa-edit text-dark"></i></label><br>

                        <?php endif; ?>


                        <label><?= $admin->Fonction; ?></label>
                    </div>
                </div> 
