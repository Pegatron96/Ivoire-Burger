    ...
    <div id="page-content-wrapper">
        ...
        <div class="container img-thumbnail col-md-6" style="background: #19D6E4 ;color:#3e3e3e !important; padding:15px;">
            <div class="row justify-content-center">
                <h4 class="text-white" style="padding-left:15px;"><i style="padding:10px;color:#19D6E4 !important;" class="text-dark img-thumbnail bg-white text-info fa fa-remove"></i> Supprimer un administrateur</h4>
            </div>
        ...
        <table class="table-striped table-bordered bg-white" style="margin:auto!important;width:auto;border:2px #19D6E4 solid;">
            <thead>
            <tr>
                <th>#</th>
                <th>Nom</th>
            ...
            <?php while($admin = $req->fetch(PDO::FETCH_OBJ)):  ?>
            ...
            <tbody style="font-size:15px;">
                <tr>
                    ...
                    <td class="text-lowercase"><?= $admin->username; ?></td>
                    <td><?= $admin->Fonction; ?></td>
                    <td><a class="btn btn-danger" href="delete-ad.php?id=<?= $admin->id; ?>">Supprimer l'admin <i class="fa fa-remove"></i></a></td>
                </tr>
