...
$req = $db->prepare("SELECT * FROM admin WHERE id = ?");
...
{
    $adm = $database->query("DELETE FROM admin WHERE id=:id", array('id' => $_GET['id']));


    $_SESSION['flash']['success'] = "Le compte a bien été supprimé";

    header("Location: delete-admin.php");
...
<div class="site d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container img-thumbnail col-md-6 bg-danger" style="color:#3e3e3e !important; padding:15px;">
            <div class="row justify-content-center">
                <h4 class="text-white" style="padding-left:15px;"><i style="padding:10px;color:#DC3545 !important;" class="text-dark img-thumbnail bg-white text-danger fa fa-remove"></i> Confirmer la suppression</h4>
            </div>
        ...
        <div class="dropdown-divider"></div><br><br>
            ...
            <div class="alert alert-danger justify-content-center text-center col-md-6" style="margin:auto;width:auto">
                Souhaitez vous vraiment supprimer cet administrateur ? <i class="fa fa-arrow-circle-o-down"></i><br>

                <form method="POST" action="delete-ad.php?id=<?= $admin->id; ?>" style="margin:auto !important;width:auto !important;" class="justify-content-center">
                    <div class="row">
                        <div class="col-md-4"></div>
                        <div class="col-md-4">

                            <input type="submit" name="submit" value="Oui" class="btn btn-warning">

                            <a href="javascript:history.back()" class="btn btn-warning">Non</a>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
