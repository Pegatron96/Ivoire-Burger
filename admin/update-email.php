...
if(isset($_POST['submit']))
{
    ...
    if($isSuccess)
    {
        $req = $db->prepare("UPDATE admin SET email = ? WHERE id = ?");
        $req->execute([$email, $admin->id]);
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container img-thumbnail col-md-6" style="background: #19D6E4 ;color:#3e3e3e !important; padding:15px;">
            <div class="row justify-content-center">
                <h4 class="text-white" style="padding-left:15px;"><i style="padding:10px;color:#19D6E4 !important;" class="text-dark img-thumbnail bg-white fa fa-check"></i> Mise à jour de l'adresse e-mail</h4>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="email" value="<?= $admin->email; ?>" class="form-control text-center">
