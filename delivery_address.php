...
if(isset($_POST['check']))
{
    ...
    $region = verifyInput($_POST['region']);
    $adresse = verifyInput($_POST['adresse']);

    $db = Database::connect();

    $req = $db->prepare("UPDATE users SET firstname = ?, lastname = ?, phone = ?, ville = ?, region = ?, adress = ? WHERE id = ?");

    $req->execute([$firstname, $lastname, $phone, $city, $region, $adresse, $_SESSION['auth']['id']]);
...
if(isset($_POST['v_a']))
{
        header("Location: delivery_mode.php");
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="delivery img-thumbnail">
                                <h8 style="color:#B2AEB1; text-transform: uppercase;" class="font-weight-bold">finalisation de votre commande <?= $_SESSION['auth']['lastname']; ?> </h8>
                                <div class="row">
                                    <?php if(!empty($user->adress)): ?>
                                        <h8 class="col-md-6 text-dark font-weight-bold"><img src="img/validate.PNG" alt="" class="small_image"> 1. ADRESSE</h8>
                                        <h8 data-toggle="modal" data-target="#monModal" style="cursor: pointer; color: #e7480f" class="text-right col-md-6 font-weight-bold">MODIFIER</h8>

                                        <div class="modal fade" id="monModal" style="font-family: sans-serif">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4  class="modal-title">Modification de l'adresse de livraison <i class="fa fa-building-o"></i></h4>
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="update_add" method="POST" action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="adresse" value="<?= $user->adress; ?>">
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="city" class="form-control">
                                                                            ...
                                                                            if(!empty($user->ville)):
                                                                                ?>
                                                                                <option selected value="<?= $user->ville; ?>"><?= $user->ville; ?></option>
                                                                                <option value="Koumassi Nord-Est">Koumassi Nord-Est</option>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-order btn-block" name="check">Enregistrer</button>
                                                    </div>
                                                    </form>
                                                </div>
                                            </div>
                                    ...
                                    <?php elseif(empty($user->adress)): ?>
                                        <h8 style="padding-left:2rem;" class="col-md-6 text-dark font-weight-bold"><img src="img/unvalidate.PNG" alt="" class="small_image"> 1. ADRESSE</h8>
                                        <h8 data-toggle="modal" data-target="#add" style="cursor:pointer; color: #e7480f" class="text-right col-md-6 font-weight-bold">AJOUTER</h8>

                                        <div class="modal fade" id="add" style="font-family: sans-serif">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4  class="modal-title">Modification de l'adresse de livraison <i class="fa fa-building-o"></i></h4>
                                ...
                                <h8 class="font-weight-bold"><?= $user->lastname . " " . $user->firstname; ?></h8> <br>

                                <?php if(!empty($user->adress) && !empty($user->phone)): ?>

                                    <p class="addresse"><i class="fa fa-angle-right"></i> <?= $user->adress; ?></p>
                                    <p class="phone"><i class="fa fa-angle-right"></i> <?= $user->phone; ?></p>

                                <?php else: ?>

                                    <h8 class="addresse">Ajoutez une adresse et un contact sinon votre commande sera annulée.</h8>

                                <?php endif; ?>

                                <?php if(!empty($user->adress) && !empty($user->phone) && !empty($user->region) && !empty($user->ville)): ?>
                                 <form method="POST" action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                                     <input type="submit" name="v_a" value="ETAPE SUIVANTE" class="btn btn-order btn-block">
                                 </form>

                                <?php else: ?>

                                    <button type="button" class="btn btn-outline-secondary btn-block">Remplissez les infos ci-dessus avant de continuer</button>
