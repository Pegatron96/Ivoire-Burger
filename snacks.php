...
<head>
    ...
    <title>Ivoire Burger | Snacks</title>
...
<div class="container site">
    ...
    <nav style="background:rgba(255, 193, 7, 0.589);" class="img-thumbnail">
        <ul style="margin-left:25px; width:auto;" class="nav nav-pills" id="pills-tab" role="tablist">
            <li><a class="nav-link" href="index.php" role="tab">Accueil</a></li>
            <li><a class="nav-link" href="menus.php" role="tab" >Menus</a></li>
            <li><a class="nav-link" href="burgers.php"> Burgers</a></li>
            <li><a style="background: #e7480f;" class="nav-link" href="snacks.php">Snacks</a></li>
            <li><a class="nav-link" href="salades.php">Salades</a></li>
            <li><a class="nav-link" href="boissons.php">Boissons</a></li>
            <li><a class="nav-link" href="desserts.php">Désserts</a></li>
            <li><a class="cart nav-link" href="cart.php"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <?php if(isset($_SESSION['auth'])): ?>
                ...
                <li class="nav-item user nav-link"> <i class="fa fa-users dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></i>
                    <ul style="font-family:sans-serif; text-shadow: none" class="drop text-justify dropdown-menu">
                        ...
                        <li class="dropdown-divider"></li>
                        <li><a href="#"><i class="fa fa-heart-o"></i> Liste d'envie</a> </li>
                        <li class="dropdown-divider"></li>
                        <li><a href="#"><i class="fa fa-dropbox"></i> Mes commandes</a> </li>
                        <li class="dropdown-divider"></li>
            ...
            <?php endif; ?>
            <li>
                <form method="GET" action="snacks.php">
    ...
    <div style="margin-top:30px;" id="pills-tabContent" class="tab-content">
        <div class="tab-pane fade show active" role="tabpanel" id="3">
            <div class="row">
                ...
                FROM items WHERE items.category = 3 ORDER BY items.id DESC");
