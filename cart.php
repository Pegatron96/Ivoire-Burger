...
<head>
    ...
    <title>Ivoire Burger | Votre panier</title>
        ...
        <div class="tab-pane fade show active" role="tabpanel" id="5">
            <div class="row">
                ...
                <div class="img-thumbnail container panier">
                    ...
                    <?php if($panier->count() == 1): ?>

                        <h2>Panier (<?= $panier->count(); ?> produit)</h2> <br>

                    <?php else: ?>

                        <h2>Panier (<?= $panier->count(); ?> produits)</h2> <br>
                   ...
                   <table class="table-bordered table-striped col-md-12">
                       ...
                       <tbody>
                            ...
                            <tr class="img-thumbnail">
                                ...
                                <td><div style="padding-left:20px"><img style="width:60px; height:60px;" src="img/<?= $product->image ?>">  <?= $product->name; ?></div>
                                <td class="text-center"><div class="quantity"><?= $_SESSION['panier'][$product->id] ; ?></div></td>
                                <td class="text-center"><div class="pricee"><?= $product->price ?> F.CFA</div></td>
                                <td class="text-center" style="color: #e7480f"><div class="total"><?= $product->price * $_SESSION['panier'][$product->id]; ?> F.CFA</div></td>
                                <td class="text-center"><a style="color: #e7480f; font-size: 18px" href="cart.php?del=<?= $product->id; ?>" class="del"><i id="tool" data-toggle="tooltip" title="Supprimer du panier" class="fa fa-remove"></i></a></td>
                            </tr>
                    ...
                    <div class="text-right" style="font-weight: bold; font-size: 20px">Total : <span style="color: #e7480f"><?= $panier->total(); ?> F.CFA</span></div> <br>
                        ...
                        <div class="row img-thumbnail bg-white justify-content-end" style="padding:10px;">
                            ...
                            <a class="btn btn-order img-thumbnail" href="delivery_address.php">FINALISER LA COMMANDE</a>
                        </div>
                ...
                <?php else: ?>
                    ...
                    <div style="background: #F5F5F5 !important;" class="img-thumbnail container panier text-center">
                      <h2 class="text-left">Panier</h2>
                        <h5 style="color:#3e3e3e;">Votre panier est vide <?= $_SESSION['auth']['lastname'] ?> !</h5>

                        <img class="col-md-3" src="img/cart-empty.png" alt=""> <br><br>
                        <a href="index.php" class="btn btn-order btn-md">COMMENCEZ VOTRE DEGUSTATION</a>
