...
$timeOut = $database->query("SELECT * FROM users WHERE confirmed_command > DATE_SUB(NOW(), INTERVAL 5 MINUTE) AND id=:id", array('id' => $_SESSION['auth']['id']));

if(!$timeOut)
{
    $_SESSION['flash']['danger'] = "Votre session a été interrompue pour inactivité !";
...
<head>
    ...
    <title>Ivoire Burger | Félicitations</title>
...
<body style="z-index: 900 !important;">
...
<div class="container site">
     ...
     <h1 style="text-transform: uppercase" class="text-center text-logo">
    ...
    <nav style="background:rgba(255, 193, 7, 0.589);" class="img-thumbnail">
        <ul style="margin-left:25px; width:auto;" class="nav nav-pills" id="pills-tab">
            ...
            <li style="cursor:pointer !important;" role="presentation" class="nav-item"><a  class="cart nav-link" href="cart.php" id="pills-desserts-tab" ><i style="cursor:pointer !important;" class="fa fa-shopping-cart"></i></a></li>
        ...
        <div class="tab-pane fade show active" role="tabpanel">
            <div class="row">
                ...
                <div class="container" style="font-family: sans-serif">
                    <div class="img-thumbnail congrat-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 text-center">
                                    ...
                                    <h4 class="text-success font-weight-bold">
                                        ...
                                        <i style="background:transparent !important;font-size:160px;" class="text-center center fa fa-check-circle"></i>
                                        <br> Félicitation <?= $_SESSION['auth']['lastname']; ?> !
                                    </h4>
                                ...
                                <div style="word-wrap: break-word !important;" class="row justify-content-center">
                                    <!--<div class="col-md-1"></div>-->
                                    <div class="col-md-3 col-sm-3 img-thumbnail" style="background: #F5F5F5; padding:10px;">
                                        <div class="form-group">
                                            <h4 class="text-center"><i class="fa fa-opencart"></i> Confirmation</h4>

                                            <p style="margin-top:20px; font-size:14px;">
                                                Félicitations

                                                <?php if($_SESSION['auth']['sex'] == "Masculin"): ?>
                                                    Monsieur
                                                <?php elseif($_SESSION['auth']['sex'] == "F&eacute;minin"): ?>
                                                    Madame
                                                <?php else: ?>

                                                <?php endif; ?>

                                                Votre commande a bien été enregistée! Un e-mail de confirmation vous a été envoyé, vous y verrez les détails de votre
                                                commande.
                                    ...
                                    <div class="col-md-1 col-sm-1 bg-transparent text-white">JU</div>

                                    <div class="col-md-3 col-sm-3 img-thumbnail" style="background: #F5F5F5; padding:10px;">
                                        <div class="form-group">
                                            <h4 class="text-center"><i class="fa fa-sort-numeric-asc"></i> ID commande</h4>

                                            <?php

                                            $db = Database::connect();

                                            $req = $db->prepare("SELECT command_id, delivery_mode FROM users WHERE id = ?");

                                            $req->execute([$_SESSION['auth']['id']]);

                                            $command = $req->fetch(PDO::FETCH_OBJ);



                                            ?>

                                            <p style="font-size:22px; margin-top:20px;" class="text-center font-weight-bold"><?= $command->command_id ?></p> <br>
                                            <!--<div style="word-spacing: 5px;" class="row text-center font-weight-bold justify-content-center">
                                                <div id="days" class="time col-md-2"></div>
                                                <div id="hours" class="time col-md-2"></div>
                                                <div id="minutes" class="time col-md-2"></div>
                                                <div id="seconds" class="time col-md-2"></div>
                                            </div>-->
                                        </div>

                                    </div>
                                   <div class="text-white col-md-1 col-sm-1">DE</div>

                                    <div class="col-md-3 col-sm-3 img-thumbnail" style="background: #F5F5F5; padding:10px;">
                                        <div class="form-group">
                                            <h4 class="text-center"><i class="fa fa-car"></i> Expédition</h4>
                                            <p style="font-size:14px; margin-top:20px;">
                                                <?php if($command->delivery_mode == "R&eacute;cup&eacute;ration au restaurant"): ?>
                                                     Votre commande sera préparée et vous pourrez venir la récupérée au restaurant dès réception de l'e-mail
                                                <?php else: ?>
                                                    Votre commande sera préparée et expédiée à votre adresse par un de nos livreurs
                                                <?php endif; ?>
                                            </p>
                                        </div>
                                    </div>
                ...
                <?php elseif(!empty($_GET)): ?>
                    ...
                    <div style="background: rgb(255,255,255); border-radius: 15px; padding:20px; padding-left:25px; margin-top: 45px;" class="container res">
