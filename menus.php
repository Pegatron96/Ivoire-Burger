...
<div id="preloader">
    ...
    <div class="container site">
        ...
        <?php// require_once "sidebar/side.php"; ?>
    <nav style="background:rgba(255, 193, 7, 0.589);" class="img-thumbnail">
        ...
        <ul style="margin-left:25px; width:auto;" class="nav nav-pills" id="pills-tab" role="tablist">
            ...
            <li role="presentation" class="nav-item"><a style="background: #e7480f;"  class="nav-link active" href="menus.php">Menus</a></li>
            <li role="presentation" class="nav-item"><a class="nav-link" href="burgers.php"> Burgers</a></li>
    ...
    <div style="margin-top:30px;" id="pills-tabContent" class="tab-content">
        <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="pills-menus-tab" id="1">
            <div class="row">
                ...
                FROM items WHERE items.category = 1 ORDER BY items.id DESC");
                ...
                <div style="background: #fff; border-radius: 15px; padding:20px; padding-left:25px; margin-top: 45px;" class="container res">
                    ...
                    $result = preg_replace("#[^a-z ?0-9]#i","", $_GET['search']);
                   ...
                   // }
                    ?>
                        ...
                        <?php else:  ?>
                            ...
                            <h1 style="padding-bottom: 200px; word-wrap: break-word;" id="res"><?php echo "Oups... désolé aucun résultat ne correspond à <strong style='text-transform:capitalize'>$result</strong>"; ?></h1>
