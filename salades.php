...
<head>
    ...
    <title>Ivoire Burger | Salades</title>
...
<div class="container site">
    ...
    <nav style="background:rgba(255, 193, 7, 0.589);" class="img-thumbnail">
        <ul style="margin-left:25px; width:auto;" class="nav nav-pills" id="pills-tab" role="tablist">
            ...
            <li role="presentation" class="nav-item"><a style="background: #e7480f;" class="nav-link active" href="salades.php">Salades</a></li>
            ...
            <li role="presentation" class="nav-item">
                <form method="GET" action="salades.php">
    ...
    <div style="margin-top:30px;" id="pills-tabContent" class="tab-content">
        <div class="tab-pane fade show active" role="tabpanel" id="4">
            <div class="row">
                ...
                FROM items WHERE items.category = 4 ORDER BY items.id DESC");
