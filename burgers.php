...
<head>
    ...
    <title>Ivoire Burger | Burgers</title>
...
<div class="container site">
    ...
    <nav style="background:rgba(255, 193, 7, 0.589);" class="img-thumbnail">
        <ul style="margin-left:25px; width:auto;" class="nav nav-pills" id="pills-tab">
            <li role="presentation" class="nav-item"><a href="index.php" class="nav-link" id="pills-menus-tab">Accueil</a></li>
            <li role="presentation" class="nav-item"><a href="menus.php" class="nav-link" id="pills-menus-tab">Menus</a></li>
            <li role="presentation" class="nav-item active"><a style="background: #e7480f;" class="nav-link active" href="burgers.php"  id="pills-burgers-tab"> Burgers</a></li>
            ...
            <li role="presentation" class="nav-item">
                <form method="GET" action="burgers.php">
    ...
    <div style="margin-top:30px;" id="pills-tabContent" class="tab-content">
        <div class="tab-pane fade show active" role="tabpanel" id="2">
            <div class="row">
                ...
                FROM items WHERE items.category = 2 ORDER BY items.id DESC");
