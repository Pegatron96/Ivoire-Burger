...
{
    if(strlen($user->command_id) != 12)
    {
        $_SESSION['flash']['danger'] = "Vous n'avez aucune commandes en cours";
...
<head>
    ...
    <title>Ivoire Burger | Mes commandes</title>
    ...
    <div style="margin-top:30px;" id="pills-tabContent" class="tab-content">
        <div class="tab-pane fade show active" role="tabpanel">
            <div class="row">
              ...
              <div class="container img-thumbnail" style="font-family:sans-serif;padding:23px;">
                <h3>Mes commandes (<?= $panier->count() ?>)</h3><br>
                 ...
                 <div style="padding: 17px; word-wrap: break-word !important;" class="table-bordered">
                     <div class="row">
                         <div class="col-md-10">
                             <img class="col-md-2 image" src="../img/<?= $product->image; ?>"> <span>Qté <?= $_SESSION['panier'][$product->id] ?></span>
                             <?php
                             ...
                             <?php $new_time = preg_replace('#([0-9]{4})-([0-9]{2})-([0-9]{2}) ([0-9]{2}):([0-9]{2}):([0-9]{2})#', '$3/$2/$1', $use->confirmed_command); ?>



                             <span style="font-size: 13px"><?= $product->description; ?></span> <div style="vertical-align: top !important; font-size: 12px;">commandée le <?= $new_time; ?> </div>
                         </div>
                         <div class="col-md-2">
                             <a href="details_checkout.php?id=<?= $use->id; ?>" class="btn btn-order btn-md text-uppercase">détails</a>
                    ...
                    <div style="background: rgb(255,255,255); border-radius: 15px; padding:20px; padding-left:25px; margin-top: 45px;" class="container res">
                        ...
                        <?php else:  ?>
                            ...
                            <div class="text-center col-md-12 col-lg-12">
                                ...
                                <img style="position:absolute; bottom:500px !important;width:400px" class="img-responsive" src="../img/tenor.gif">
