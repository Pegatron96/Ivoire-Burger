...
if(isset($_POST['sub_submit']))
{
    ...
    if(!empty($region))
    {
        $req = $db->prepare("UPDATE users SET region = ? WHERE id = ?");

        $req->execute([$region, $_SESSION['auth']['id']]);

        $_SESSION['flash']['success'] = "L'addresse a bien été modifiée" . " " .  $_SESSION['auth']['lastname'];
        ...
        $_SESSION['flash']['danger'] = "Sélectionnez une région valide";
    }
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="region">Modifier la région <i class="fa fa-home"></i></label>
                                    <select class="form-control" name="region">

                                        <option name="region" value="Abidjan-lagunes" selected>Abidjan-Lagunes</option>
                                        <option name="region" value="Bouake" selected>Bouaké</option>
