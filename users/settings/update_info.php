...
$new_date = preg_replace("#([0-9]{4})-([0-9]{2})-([0-9]{2})#", "$3/$2/$1", $_SESSION['auth']['birthday']);
...
if(isset($_POST['sub_submit']))
{
        ...
        {
        $req = $db->prepare("UPDATE users SET phone = ?, firstname = ?, lastname = ? WHERE id = ?");

        $req->execute([$phone, $firstname, $lastname, $_SESSION['auth']['id']]);
...
<head>
    ...
    <title>Ivoire Burger | Mise à jour des informations du compte</title>
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-lg-9">
                    <form method="POST" action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" style="background: #fff; padding: 15px;">
                        <h4 class="text-justify" style="color:#495057">Informations personnelles <i class="fa fa-user-times"></i></h4> <br>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="firstname">Nom <i class="fa fa-user"></i></label>
                                    <input type="text" name="firstname" value="<?= $_SESSION['auth']['firstname'] ?>" class="form-control">
                                </div>
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    <label for="email">E-mail <i class="fa fa-envelope-o"></i></label>
                                    <input type="email" name="email" value="<?= $_SESSION['auth']['email'] ?>" class="form-control">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="phone">Numéro de téléphone <i class="fa fa-phone-square"></i></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label>Sexe <i class="fa fa-transgender"></i> | <a style="color:#000" target="_blank" href="update_sex.php?for=<?= $_SESSION['auth']['lastname'] . $_SESSION['auth']['firstname'] ?>">Modifier <i class="fa fa-pencil-square"></i></a> </label>

                                  <?php if(!empty($_SESSION['auth']['sex'])): ?>

                                    <div class="form-control"><?= $_SESSION['auth']['sex']; ?></div>

                                    <?php else: ?>

                                  <div class="form-control">Vous n'avez encore rien renseigner</div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label>Date de naissance <i class="fa fa-calendar-o"></i> | <a style="color:#000" target="_blank" href="update_date.php?for=<?= $_SESSION['auth']['lastname'] . $_SESSION['auth']['firstname'] ?>">Modifier <i class="fa fa-pencil-square"></i></a> </label>
                                    <div class="form-control"><?= $new_date; ?></div>
