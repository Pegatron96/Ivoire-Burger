...
if(isset($_POST['sub_submit']))
{
    ...
    if(!empty($birthday))
    {
        $req = $db->prepare("UPDATE users SET birthday = ? WHERE id = ?");

        $req->execute([$birthday, $_SESSION['auth']['id']]);

        $_SESSION['flash']['success'] = "La date de naissance a bien été modifié" . " " .  $_SESSION['auth']['lastname'];
        ...
        $_SESSION['flash']['danger'] = "Saisissez une date valide";
    }
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sexe">Modifier date <i class="fa fa-calendar-o"></i></label>
