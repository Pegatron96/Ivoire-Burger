...
if(isset($_POST['sub_submit']))
{
    ...
    if(!empty($sex))
    {
        $req = $db->prepare("UPDATE users SET sex = ? WHERE id = ?");

        $req->execute([$sex, $_SESSION['auth']['id']]);

        $_SESSION['flash']['success'] = "Le sexe a bien été modifié" . " " .  $_SESSION['auth']['lastname'];
        ...
        $_SESSION['flash']['danger'] = "Sélectionnez votre sexe dans la liste";
    }
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sexe">Modifier sexe <i class="fa fa-transgender"></i></label>
                                    <select class="form-control" name="sex">

                                        <option name="sex" value="Féminin" selected>Féminin</option>
                                        <option name="sex" value="Masculin" selected>Masculin</option>
