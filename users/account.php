...
<head>
    ...
    <title>Ivoire Burger | Compte utilisateur</title>
       ...
       <div class="row">
           <nav class="col-md-3 col-xs-3 img-thumbnail" style="border: 0px; background: #fff !important; padding: 13px; margin-bottom:20px;">
               ...
               <li class="dropdown-divider"></li>
                   <a class="naving" href="profile.php"><li class="nav-item"><i class="fa fa-dashboard"></i> Mon Profile client</li></a><br>
                   ...
                   <li class="dropdown-divider"></li>
                   <a class="naving" href="settings/update_info.php?update_info_for=<?= $_SESSION['auth']['lastname'] . $_SESSION['auth']['firstname'] ?>">
                   <li class="nav-item"><i class="fa fa-info-circle"></i> Informations personnelles</li></a><br>
                   <a class="naving" href="settings/update_pwd.php?update_pwd_for=<?= $_SESSION['auth']['lastname'] . $_SESSION['auth']['firstname'] ?>"><li class="nav-item"><i class="fa fa-lock"></i> Modifier mot de passe</li></a><br>
                   <a class="naving" href="settings/update_addresse.php"><li class="nav-item"><i class="fa fa-building"></i> Adresses de livraison</li></a>
                   <li class="dropdown-divider"></li>
           ...
           <div class="col-md-8" style="border: 0px; background: #fff !important; padding: 13px; margin-left:1.5rem;">
               <h4>Votre compte</h4> <br>
               <div class="row">
                   <div class="col-md-6">
               <table class="table-bordered container">
                   <thead>
                   <tr>
                       <th>Informations personnelles

                               <a data-toggle="tooltip" title="Modifier les informations personnelles" class="naving" href="settings/update_info.php">
                                   <i style="position:relative;left: 80px;font-size: 20px; color: #e7480f;" class="text-right fa fa-pencil"></i>
                               </a>
                       </th>
                   ...
                   <tbody>
                    <tr>
                        <td><?= $_SESSION['auth']['lastname']. " " . $_SESSION['auth']['firstname']; ?> <br><br>
                            
                            <span><?php echo $_SESSION['auth']['email']; ?></span> <br><br><br>

                            <span id="update">
                                <a data-toggle="tooltip" title="Modifier l'addresse" href="settings/update_pwd.php">Modifier mon mot de passe</a>
                                <i class="locked fa fa-lock"></i>
                            </span>
                   ...
                   <div class="col-md-6">
                       <table class="table-bordered container">
                           <thead>
                           <tr>
                               <th>Mon adresse de livraison

                                       <a class="naving" href="settings/update_addresse.php">
                                           <i style="position:relative;left: 80px;font-size: 20px; color: #e7480f;" class="text-right fa fa-pencil"></i>
                                       </a>
                               </th>
                           ...
                           <tbody>
                           <tr>
                               <td>Adresse principale: <br>

                                    <span style="font-style:normal; text-transform: capitalize !important; color: #495057;">
                                        <?= $_SESSION['auth']['lastname'] . " " . $_SESSION['auth']['firstname'] ?> <br>
                                        <?=  $_SESSION['auth']['adress'] ?> <br>
                                        <?= $_SESSION['auth']['ville'] ?>, 
                                        <?= $_SESSION['auth']['region']; ?>
